...
function UploadStep({ onParsed }) {
  ...
  const loadRealMix = async () => {
    ...
    try {
      const names = [
        "JOOR_Full_Access_Linesheet_Template.xlsx",
        "Le New Black Company Data Template.xlsx",
        "Le New Black Pricesheet Template.xlsx",
        "Le New Black Product Data Template.xlsx",
        "Shopify Products_export.xlsx",
        "shopify_products_export_1.xlsx",
        "XO_Maria_Shopify_Export.xlsx",
      ];
      const fs = [];
