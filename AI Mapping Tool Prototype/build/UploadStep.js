// AUTO-GENERATED from app/UploadStep.jsx — do not edit directly. Re-run the precompile to regenerate.
...
function UploadStep({
  ...
  const loadRealMix = async () => {
    setPhase("analyzing");
    try {
      const names = ["Cami NYC - Joor Linesheets.xlsx", "Le New Black Pricesheet Template.xlsx", "Anaz faire-products.xlsx", "12_24 VELOCI Updated Shopify Export.xlsx", "Jewels By Sunaina (Shopify export).xlsx", "customerDetails.csv", "XO Maria Shopify products_export_1.csv"];
      const fs = [];
    ...
    for (const tf of triage.files) {
      ...
      if (key) {
        return {
          ...
          headerRow: dataSheet.header_row || 0,
          key,
          label: tf.purpose_label
        };
      }
    }
    return null;
  }, [triage, selection, files]);
  if (phase === "analyzing") return /*#__PURE__*/React.createElement(AnalyzingView, {
    files: files
  });
  if (phase === "triage" && triage) {
    return /*#__PURE__*/React.createElement(TriageView, {
      files: files,
      triage: triage,
      selection: selection,
  ...
  }, "Upload your catalog files"), /*#__PURE__*/React.createElement("p", {
    style: {
      marginTop: 8,
      marginBottom: 0,
      color: "var(--hl-fg-2)",
  ...
  }, "Drop any combination of CSVs, Excel workbooks, vendor templates, or platform exports. Our triage agent reads every file and every tab, picks the right source, and finds the column headers \u2014 even when they're buried under instructions or annotations.")), /*#__PURE__*/React.createElement("div", {
    onDragOver: e => {
      e.preventDefault();
      setDragOver(true);
    },
  ...
  }, dragOver ? "Drop to analyze" : "Drag files here"), /*#__PURE__*/React.createElement("div", {
    style: {
      color: "var(--hl-fg-2)",
      fontSize: 14,
      marginBottom: 20
  ...
  }, "select up to 10 files")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "inline-flex",
      alignItems: "center",
      gap: 16,
  ...
  }), "XLSX"), /*#__PURE__*/React.createElement("span", {
    style: {
      width: 4,
      height: 4,
      background: "var(--hl-keyline)",
  ...
  }), /*#__PURE__*/React.createElement("span", null, "Multi-sheet supported"), /*#__PURE__*/React.createElement("span", {
    style: {
      width: 4,
      height: 4,
      background: "var(--hl-keyline)",
  ...
  }), /*#__PURE__*/React.createElement("span", null, "Up to 50 MB / file")), /*#__PURE__*/React.createElement("input", {
    ref: fileRef,
    type: "file",
    accept: ".csv,.xlsx,.xls",
    multiple: true,
  ...
  }, /*#__PURE__*/React.createElement(HelpTile, {
    icon: "layer-group",
    title: "Multi-file uploads",
    body: "Drop a vendor template alongside an export \u2014 we'll pick the one with the real product rows and explain why."
  }), /*#__PURE__*/React.createElement(HelpTile, {
    icon: "folder-open",
    title: "Sheet-aware",
    body: "Skips Instructions, Field Descriptions, and reference lookup tabs to find the real data table inside a workbook."
  }), /*#__PURE__*/React.createElement(HelpTile, {
    icon: "search",
    title: "Smart header detection",
    body: "Finds the header row even when annotations, dividers, or empty rows sit above it."
  })), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 24,
      padding: "20px 24px",
      background: "var(--hl-info-blue)",
      borderRadius: 3
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "Try the AI triage agent"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 13,
      color: "var(--hl-fg-2)",
      marginBottom: 14,
  ...
  }, "Load a real brand export and watch the agent classify it, find the headers, group multi-row products, and map the columns."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexWrap: "wrap",
      gap: 8
    }
  }, /*#__PURE__*/React.createElement(SampleChip, {
    label: "Messy real upload",
    hint: "7 files \xB7 picks the right one",
    onClick: loadRealMix
  }), /*#__PURE__*/React.createElement(SampleChip, {
    label: "Shopify multi-row",
    hint: "115 rows \u2192 52 products + images",
    onClick: () => loadSingleUpload("uploads/xo_maria_multirow.csv", "XO Maria Shopify products_export.csv")
  }), /*#__PURE__*/React.createElement(SampleChip, {
    label: "Large Shopify catalog",
    hint: "82 cols \xB7 2,199 rows",
    onClick: () => loadSingleUpload("uploads/Hortons EngLand Shopify product export.xlsx", "Hortons England Shopify product export.xlsx")
  }), /*#__PURE__*/React.createElement(SampleChip, {
    label: "JOOR linesheet",
    hint: "113 cols \xB7 tiered pricing",
    onClick: () => loadSingleUpload("uploads/BEC AND BRIDGE - Joor Linesheets.csv", "BEC AND BRIDGE - Joor Linesheets.csv")
  }), /*#__PURE__*/React.createElement(SampleChip, {
    label: "JOOR \u2014 Cami NYC",
    hint: "87 cols \xB7 real brand export",
    onClick: () => loadSingleUpload("uploads/Cami NYC - Joor Linesheets.xlsx", "Cami NYC - Joor Linesheets.xlsx")
  }), /*#__PURE__*/React.createElement(SampleChip, {
    label: "Faire export",
    hint: "annotation rows \xB7 option pairs",
    onClick: () => loadSingleUpload("uploads/Anaz faire-products.xlsx", "Anaz faire-products.xlsx")
  }), /*#__PURE__*/React.createElement(SampleChip, {
    label: "Large Faire",
    hint: "66 cols \xB7 1,001 rows \xB7 buried header",
    onClick: () => loadSingleUpload("uploads/Lemonbella Faire edited.xlsx", "Lemonbella Faire edited.xlsx")
  }), /*#__PURE__*/React.createElement(SampleChip, {
    label: "Customer file",
    hint: "routes to account import",
    onClick: () => loadSingleUpload("uploads/JOOR_Full_Access_Customer_Data_Template.xlsx", "JOOR_Full_Access_Customer_Data_Template.xlsx")
  }), /*#__PURE__*/React.createElement(SampleChip, {
    label: "With errors",
    hint: "dupes + missing",
    onClick: () => handleSample("errors")
  }))))));
}
...
function AnalyzingView({
  ...
  const phases = [{
    ...
    label: "Scanning sheets",
    icon: "layer-group"
  }, {
    label: "Identifying source",
    icon: "robot"
  }, {
    label: "Locating headers",
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "fas fa-robot fa-pulse"
  })), /*#__PURE__*/React.createElement("h2", {
    style: {
      margin: 0,
      fontSize: 24,
  ...
  }, "Triage agent is reading your files"), /*#__PURE__*/React.createElement("p", {
    style: {
      marginTop: 8,
      marginBottom: 28,
      color: "var(--hl-fg-2)"
    }
  }, "Analyzing ", /*#__PURE__*/React.createElement("b", null, files.length), " file", files.length === 1 ? "" : "s", " \xB7 ", /*#__PURE__*/React.createElement("b", null, totalSheets), " sheet", totalSheets === 1 ? "" : "s", " to find the right source for your import."), /*#__PURE__*/React.createElement("div", {
    style: {
      background: "#fff",
    ...
    }) : isActive ? /*#__PURE__*/React.createElement("i", {
      className: "fas fa-spinner fa-spin"
    }) : i + 1), /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: 14,
        fontWeight: isActive ? 700 : 400,
        color: isActive || done ? "var(--hl-icon)" : "var(--hl-fg-3)"
      }
    }, p.label));
  }), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, files.slice(0, 6).map(f => /*#__PURE__*/React.createElement("div", {
    key: f.filename,
    style: {
      display: "flex",
      alignItems: "center",
    ...
    className: `fas fa-${f.ext === "csv" ? "file-csv" : "file-excel"}`,
    style: {
      color: "var(--hl-go-blue)",
      width: 14
    }
  ...
  }, f.filename), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 11,
      color: "var(--hl-fg-3)"
    }
  }, f.sheets?.length || 0, " sheet", (f.sheets?.length || 0) === 1 ? "" : "s"))))));
}
...
function TriageView({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Review what we found"), /*#__PURE__*/React.createElement("p", {
    style: {
      marginTop: 8,
      marginBottom: 0,
      color: "var(--hl-fg-2)",
  ...
  }, "We classified ", /*#__PURE__*/React.createElement("b", null, files.length), " file", files.length === 1 ? "" : "s", " and ", /*#__PURE__*/React.createElement("b", null, totalSheets), " sheet", totalSheets === 1 ? "" : "s", ". Confirm the source we picked, or choose a different one.")), /*#__PURE__*/React.createElement(Button, {
    variant: "text",
    icon: "redo",
    onClick: onStartOver
  }, "Upload different files")), triage.rationale && /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "Triage agent recommends ", /*#__PURE__*/React.createElement("b", null, "\"", triage.primary_sheet, "\""), " from ", /*#__PURE__*/React.createElement("b", null, triage.primary_file), triage._source === "heuristic" && /*#__PURE__*/React.createElement("span", {
    style: {
      marginLeft: 8,
      padding: "2px 8px",
  ...
  }, "Offline heuristic")), /*#__PURE__*/React.createElement("div", {
    style: {
      color: "var(--hl-fg-2)"
    }
  }, triage.rationale))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexDirection: "column",
      gap: 12,
  ...
  }, triage.files.map(t => /*#__PURE__*/React.createElement(FileCard, {
    key: t.filename,
    triage: t,
  ...
  }))), selSheet && selTriageSheet && /*#__PURE__*/React.createElement(SheetPreview, {
    file: selFile,
    sheet: selSheet,
    triage: selTriageSheet,
    headerRow: selection.headerRow,
    setHeaderRow: r => setSelection({
      ...selection,
      headerRow: r
    })
  }), joinOpportunity && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 16,
      padding: "14px 18px",
      borderRadius: 3,
      background: "rgba(5,141,233,0.06)",
      border: "1px solid rgba(5,141,233,0.28)",
      display: "flex",
      alignItems: "center",
      gap: 14
    }
  ...
  }, "Join ", joinOpportunity.label.toLowerCase(), " from \u201C", joinOpportunity.file, "\u201D?"), /*#__PURE__*/React.createElement("div", {
    style: {
      color: "var(--hl-fg-2)"
    }
  }, "It shares a ", /*#__PURE__*/React.createElement("code", {
    style: {
  ...
  }, joinOpportunity.key), " column \u2014 we can merge its columns onto each product row.")), /*#__PURE__*/React.createElement("button", {
    ...
    className: `fas fa-${joinSel ? "check" : "plus"}`,
    style: {
      marginRight: 6
    }
  }), joinSel ? "Will join" : "Join data"))), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: "auto"
    }
  }), /*#__PURE__*/React.createElement("div", {
    ...
    icon: "arrow-left",
    onClick: onStartOver
  }, "Upload different files"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center",
      gap: 16,
    ...
    title: `${selection.sheet} — ${selection.filename}`
  }, "Importing ", /*#__PURE__*/React.createElement("b", {
    style: {
      color: "var(--hl-icon)"
    }
  }, selection.sheet)) : /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 13,
      color: "var(--hl-fg-3)"
    }
  }, "Pick a sheet to continue"), /*#__PURE__*/React.createElement(Button, {
    variant: "do",
    disabled: !selection,
    onClick: onContinue
  }, "Continue to mapping", /*#__PURE__*/React.createElement("i", {
...
const PURPOSE_TONES = {
  product_catalog: {
    fg: "var(--hl-do-green)",
    bg: "rgba(65,175,75,0.08)",
    icon: "boxes",
    dot: "var(--hl-do-green)"
  },
  pricing: {
    fg: "var(--hl-go-blue)",
    bg: "rgba(5,141,233,0.08)",
    icon: "tags",
    dot: "var(--hl-go-blue)"
  },
  customer_data: {
    fg: "#965FB0",
    bg: "rgba(150,95,176,0.08)",
    icon: "address-book",
    dot: "#965FB0"
  },
  reference_data: {
    fg: "var(--hl-supplementary)",
    bg: "rgba(102,146,176,0.10)",
    icon: "book",
    dot: "var(--hl-supplementary)"
  },
  instructions_only: {
    fg: "var(--hl-fg-3)",
    bg: "var(--hl-framing)",
...
function FileCard({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      alignItems: "center",
      gap: 14,
      borderBottom: dataSheets.length ? "1px solid var(--hl-keyline)" : 0
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      width: 40,
    ...
    className: `fas fa-${parsed?.ext === "csv" ? "file-csv" : "file-excel"}`,
    style: {
      fontSize: 18
    }
  })), /*#__PURE__*/React.createElement("div", {
  ...
  }, triage.filename), isPrimary && /*#__PURE__*/React.createElement("span", {
    style: {
      display: "inline-flex",
      alignItems: "center",
      gap: 4,
  ...
  }), triage.purpose_label), /*#__PURE__*/React.createElement("span", {
    style: {
      color: "var(--hl-fg-3)"
    }
  ...
  }, triage.summary)))), triage.sheets.length > 0 && !isSkipped && /*#__PURE__*/React.createElement("div", {
    style: {
      padding: 12,
      display: "grid",
  ...
  }, triage.sheets.map(s => /*#__PURE__*/React.createElement(SheetChip, {
    key: s.name,
    triage: s,
  ...
  }))), isSkipped && /*#__PURE__*/React.createElement("div", {
    style: {
...
function SheetChip({
  ...
  return /*#__PURE__*/React.createElement("button", {
    ...
    style: {
      textAlign: "left",
      cursor: isData ? "pointer" : "not-allowed",
      fontFamily: "inherit",
    ...
    className: `fas fa-${isData ? isSelected ? "check-circle" : "table" : "ban"}`,
    style: {
      color: isSelected ? "var(--hl-go-blue)" : tone.fg,
      fontSize: 12
    }
  }), /*#__PURE__*/React.createElement("span", {
    style: {
  ...
  }, triage.name), isData && parsed && /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 11,
      color: "var(--hl-fg-3)"
    }
  }, parsed.totalRows, "\xD7", parsed.totalCols)), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 11,
      color: tone.fg,
      fontWeight: 700,
...
function SheetPreview({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Preview \xB7 ", /*#__PURE__*/React.createElement("span", {
    style: {
      fontFamily: "var(--hl-font-mono)"
    }
  ...
  }, triage.reason)), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center",
      gap: 8,
  ...
  }, "Header row:"), /*#__PURE__*/React.createElement("select", {
    value: headerRow,
  ...
  }, preview.map((_, i) => /*#__PURE__*/React.createElement("option", {
    key: i,
    value: i
  }, "Row ", i + 1))), /*#__PURE__*/React.createElement("i", {
  ...
  }, /*#__PURE__*/React.createElement("tbody", null, preview.map((r, ri) => {
    ...
    return /*#__PURE__*/React.createElement("tr", {
      ...
      style: {
        ...
        borderBottom: "1px solid var(--hl-keyline)",
        fontWeight: 700,
        color: isHeader ? "var(--hl-do-green)" : "var(--hl-fg-3)",
    ...
    swatch: "rgba(65,175,75,0.18)",
    label: "Detected headers"
  }), /*#__PURE__*/React.createElement(Legend, {
    swatch: "var(--hl-framing)",
    label: "Skipped (above header)"
  }), /*#__PURE__*/React.createElement(Legend, {
    swatch: "#fff",
    border: true,
    label: "Data rows"
...
function SampleChip({
  ...
  return /*#__PURE__*/React.createElement("button", {
    ...
    style: {
      fontSize: 11,
      color: hover ? "rgba(255,255,255,.8)" : "var(--hl-fg-3)",
      marginTop: 2
    }
  }, hint));
}
