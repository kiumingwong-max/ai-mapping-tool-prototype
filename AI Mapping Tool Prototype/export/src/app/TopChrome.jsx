    ...
    <div style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10, marginRight: 32 }}>
        <div style={{
          ...
          <i className="fas fa-bolt" style={{ color: "#fff", fontSize: 14 }}/>
        </div>
        <div style={{ fontWeight: 900, letterSpacing: ".02em", fontSize: 15 }}>NuORDER</div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
        <div style={{
          ...
          <div style={{ width: 22, height: 22, borderRadius: "50%", background: "#41AF4B", display: "inline-flex", alignItems: "center", justifyContent: "center", fontSize: 11, fontWeight: 900 }}>TF</div>
          True Field
        </div>
